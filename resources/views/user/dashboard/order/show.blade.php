...
<div class="wrapper-show">
    ...
    @if ($order->order_status == 'completed')
        ...
        <a href="{{ route('displayInvoice', $order) }}">
            Afficher la Facture
        </a>
    ...
    <div class="order-status">
        ...
        <div class="progress">
            <div id="myBar" class="bar" style="width:10%">
                0
            </div>
        </div>
        ...
        <table class="prod-list-t">
            ...
            @foreach ($orderList as $item)
                ...
                @php
                    ...
                    {
                        $query = $item->Product($item->prod_category);
                ...
                @if($product)
                    ...
                    @php
                        ...
                        $imgPath = count($img)
                            ? $img[0]->path
                            : 'pre_assets/img/empty-img.png';

                        // FIX IMAGE PATH
                        if(
                            $product->prod_category == 'hardware' ||
                            $product->prod_category == 'software'
                        ){
                            $finalImg = asset('images/products/' . $imgPath);
                        }else{
                            $finalImg = asset('images/' . $imgPath);
                        }
                    @endphp
